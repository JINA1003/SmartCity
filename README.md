...
=======
>>>>>>> 78d156bb3cf50f8515d63adecdce113649ff6f10
...
- 평균기온은 약 0~30℃ 범위에 분포하며, 여름철(20~30℃) 데이터가 상대적으로 많이 나타남
- 습도는 대부분 50~75% 구간에 집중되어 서울의 계절적 특성을 반영
- 풍속은 2.2~2.6m/s 범위에 집중되어 큰 변동성이 없는 것으로 나타남
- THI(불쾌지수)는 40~80 범위에 분포하며, 여름철에 높은 값을 보임

> **Key Insight**
>
> 서울의 기후 변수는 계절성이 뚜렷하며, 특히 여름철 고온·고습 환경이 강하게 나타난다.


## 1-2) 연도별 CDD · HDD · THI 변화
...
- CDD(냉방도일)는 장기적으로 증가하는 추세를 보이며 냉방 수요가 지속적으로 증가하고 있음을 시사
- HDD(난방도일)는 감소하는 경향을 보여 겨울철 난방 수요는 점차 줄어드는 것으로 나타남
- THI(불쾌지수)는 완만한 증가 추세를 보여 여름철 체감 더위가 강화되고 있음을 확인
- 전력사용량은 전체적으로 증가 추세를 보이며 특히 최근 연도에서 높은 수준을 유지

> **Key Insight**
>
> 기후변화로 냉방 수요는 증가하고 난방 수요는 감소하는 방향으로 변화하고 있다.
...
- CDD는 강남구, 송파구, 광진구, 마포구 등 도심 및 동남권 지역에서 높게 나타남
- 이는 도시열섬 현상과 높은 건물 밀도의 영향을 받은 것으로 판단됨
- 반면 HDD는 도봉구, 노원구, 강북구 등 서울 북부 지역에서 높게 나타남
- 북부 지역은 상대적으로 기온이 낮아 난방 수요가 높은 것으로 해석됨

> **Key Insight**
>
> 서울 내부에서도 냉방·난방 수요의 공간적 차이가 뚜렷하게 존재한다.


## 2) 전력 수요 및 공급 분석

## 2-1) 연도·월별 전력수요량 및 공급예비율
...
- 2005년 이후 전반적으로 증가하는 추세
- 평균기온 또한 완만하게 상승하는 경향
- 월별 전력사용량은 여름철(7~8월)과 겨울철에 높음 → 냉·난방 수요의 영향 확인

### 공급예비율

- 계절적 변동이 뚜렷
- 전력수요가 증가하는 시기에 감소하는 경향
- 따라서 7~8월은 전력 취약도 관리와 전력수급 안정성 확보를 위한 핵심 관리 기간으로 판단

> **Key Insight**
>
> 여름철은 높은 전력수요와 낮은 공급예비율이 동시에 나타나는 전력 취약 시기이다.
...
- 전력 수요 높은 구: 강남구 > 서초구 > 송파구 > 영등포구 순
- 전력 수요 낮은 구: 강북구, 도봉구, 은평구 등

> **Key Insight**
>
> 서울의 전력수요는 강남권과 주요 업무지구에 집중되는 경향을 보인다.


## 3) ENSO(엘니뇨·라니냐) ONI 장기 변동 추이
...
- ONI는 장기간 동안 양(+)과 음(-) 상태가 반복적으로 나타남
- 강한 엘니뇨는 1982년, 1997년, 2015년 전후에 관측됨
- 강한 라니냐는 1970년대 중반, 1999년 전후에 나타남
- 그러나 ONI 자체는 일정한 장기 증가 또는 감소 추세를 보이지 않음

> **Key Insight**
>
> ENSO는 주기적 변동성을 가지지만 장기 추세는 확인되지 않는다.
...
- **CDD**: 전력사용량과 가장 높은 양(+)의 상관관계 (r=0.46)
- 평균기온 & THI: 약한 양의 상관관계
- HDD & ONI: 거의 상관관계가 나타나지 않음
- 공급예비율: 전력사용량과 약한 음(-)의 상관관계 → 전력 수요 증가할수록 공급예비율 감소

> **Key Insight**
>
> 서울의 전력수요는 ENSO보다 냉방수요(CDD)의 영향을 더 크게 받는 것으로 나타났다.


## 종합 결론

1. 서울의 전력수요는 장기적으로 증가하고 있다.
2. 기후변화로 인해 냉방수요(CDD)는 증가하고 난방수요(HDD)는 감소하고 있다.
3. 전력사용량은 여름철 고온기에 가장 크게 증가한다.
4. 공급예비율은 전력수요 증가 시 감소하여 여름철 전력 취약성이 높다.
5. ENSO(ONI)의 직접적인 영향은 제한적이며, 실제 전력수요는 지역 기온 및 냉방수요와 더 밀접한 관련을 가진다.
